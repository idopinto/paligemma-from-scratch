...
IMAGE_NET_STANDARD_STD = [0.5, 0.5, 0.5]
SEP_TOKEN = "\n"
...
def add_image_tokens_to_prompt(prefix_prompt, bos_token, image_seq_len, image_token):
    return f"{image_token * image_seq_len}{bos_token}{prefix_prompt}{SEP_TOKEN}"
...
class PaliGemmaProcessor:
    ...
    def __init__(self, tokenizer, num_image_tokens: int, image_size: int):
        ...
        # tokenizer described here: https://github.com/google-research/big_vision/tree/main/big_vision/configs/proj/paligemma
    ...
    def __call__(
        ...
        pixel_values = process_images(
            ...
            image_std=IMAGE_NET_STANDARD_STD,
        )
        ...
        # Returns thd input_ids and attention_mask as PyTorch tensors
